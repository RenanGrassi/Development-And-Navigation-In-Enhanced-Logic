...
{
       0,    86,    86,    89,    90,    93,    94,    97,   100,   101,
     104,   105,   108,   111,   112,   115,   116,   117,   118,   119,
     122,   123,   124,   125,   126,   127,   128,   129,   130,   133,
     134,   137,   140,   143,   146,   147,   150,   151,   154,   157,
     158,   161,   164,   167,   170,   173,   174,   175,   178,   181,
     184,   187,   188,   191,   192,   195,   196,   199,   200,   203,
     204,   207,   210,   211,   219,   220,   223,   224,   227,   228,
     229,   230,   231,   232,   235,   236,   239,   240,   241,   244,
     245,   246,   247,   250,   253,   254,   255
};
#endif
...
#line 1559 "translate.tab.c"
  ...
  case 4:
#line 90 "translate.y"
                        { executeProgram(); imprimeTabelaDeSimbolos(&tabelaDeSimbolos); }
#line 1565 "translate.tab.c"
    break;

  case 10:
#line 104 "translate.y"
                           { addId((yyvsp[0].identifier).name, variavel, (yyvsp[-1].type), line_number); }
...
#line 164 "translate.y"
                                       { addId((yyvsp[-1].identifier).name, variavel, (yyvsp[-2].type), line_number); }
