...
{
       0,    25,    25,    27,    29,    33,    35,    39,    41,    43,
      45,    47,    49,    51,    53,    55,    57,    59,    63,    65
};
#endif
...
#line 29 "testeYacc.y"
                    { yyerrok; }
#line 1103 "testeYacc.tab.c"
    break;

  case 5: /* stat: expr  */
#line 33 "testeYacc.y"
         { printf("%d\n", yyvsp[0]); }
#line 1109 "testeYacc.tab.c"
    break;

  case 6: /* stat: LETTER '=' expr  */
#line 35 "testeYacc.y"
                    { regs[yyvsp[-2]] = yyvsp[0]; }
#line 1115 "testeYacc.tab.c"
    break;

  case 7: /* expr: '(' expr ')'  */
#line 39 "testeYacc.y"
                 { yyval = yyvsp[-1]; }
#line 1121 "testeYacc.tab.c"
    break;

  case 8: /* expr: expr '*' expr  */
#line 41 "testeYacc.y"
                  { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1127 "testeYacc.tab.c"
    break;

  case 9: /* expr: expr '/' expr  */
#line 43 "testeYacc.y"
                  { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1133 "testeYacc.tab.c"
    break;

  case 10: /* expr: expr '%' expr  */
#line 45 "testeYacc.y"
                  { yyval = yyvsp[-2] % yyvsp[0]; }
#line 1139 "testeYacc.tab.c"
    break;

  case 11: /* expr: expr '+' expr  */
#line 47 "testeYacc.y"
                  { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1145 "testeYacc.tab.c"
    break;

  case 12: /* expr: expr '-' expr  */
#line 49 "testeYacc.y"
                  { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1151 "testeYacc.tab.c"
    break;

  case 13: /* expr: expr '&' expr  */
#line 51 "testeYacc.y"
                  { yyval = yyvsp[-2] & yyvsp[0]; }
#line 1157 "testeYacc.tab.c"
    break;

  case 14: /* expr: expr '|' expr  */
#line 53 "testeYacc.y"
                  { yyval = yyvsp[-2] | yyvsp[0]; }
#line 1163 "testeYacc.tab.c"
    break;

  case 15: /* expr: '-' expr  */
#line 55 "testeYacc.y"
                          { yyval = -yyvsp[0]; }
#line 1169 "testeYacc.tab.c"
    break;

  case 16: /* expr: LETTER  */
#line 57 "testeYacc.y"
           { yyval = regs[yyvsp[0]]; }
#line 1175 "testeYacc.tab.c"
    break;

  case 18: /* number: DIGIT  */
#line 63 "testeYacc.y"
          { yyval = yyvsp[0]; base = (yyvsp[0] == 0) ? 8 : 10; }
#line 1181 "testeYacc.tab.c"
    break;

  case 19: /* number: number DIGIT  */
#line 65 "testeYacc.y"
                 { yyval = base * yyvsp[-1] + yyvsp[0]; }
#line 1187 "testeYacc.tab.c"
    break;


#line 1191 "testeYacc.tab.c"
